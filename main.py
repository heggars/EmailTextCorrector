...
template = """
    ...
    Please end the email with an appropriate phrase
...
with hcol2:
    st.image(image='LOLLogo.png', width=500, caption="This email corrector should help with your written english")
